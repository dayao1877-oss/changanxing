...
使用trae完成的小规模车队管理系统，所有我能想到的功能已经全部加进去了，而且也测试成功
适用于一个调度加10个左右的司机，由调度创建订单指定司机接单，司机到达上车点和目的地需拍照公里数打卡
和甲方对账非常方便，给司机设置的单价模式非常灵活，按单，按公里数，起步价+公里数，等待费用，停车费，高速费用都可以设置
---
---
